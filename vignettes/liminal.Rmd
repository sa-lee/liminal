---
title: "Explore embeddings with liminal!"
author: "Stuart Lee"
...
tree structured data set, which is adapted from the default example in 
the phateR package [@Moon2019-ne].
...
limn_tour_link(tsne_df,
               ...
               color = branches)
```
 This function requires two tables that will be linked together in separate views. The tour interface is the same as above, except now
